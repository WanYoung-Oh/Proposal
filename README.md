...
- **RFP 자동 분석** — PDF 업로드 시 사업개요·공식 요구사항·평가항목(별첨 포함) 자동 추출 (STEP 1~3)
...
- **LLM·Temperature UI 조정** — 추출/전략 생성 LLM 개별 선택, Temperature 슬라이더로 정확성↔창의성 조절
...
| Phase 4 | Streamlit MVP UI | ✅ 완료 · **E2E 테스트 완료 (2026-06-23)** |
